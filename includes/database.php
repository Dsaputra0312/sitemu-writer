    ...
    public static function add_log($data)
    {
        ...
        return $wpdb->insert(
            ...
            array(
                ...
                'keywords_used' => isset($data['keywords_used']) ? sanitize_textarea_field($data['keywords_used']) : null,
                'angle_used' => isset($data['angle_used']) ? sanitize_text_field($data['angle_used']) : null,
                'status' => $data['status'],
